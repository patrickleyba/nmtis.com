...
<head>
	<meta charset="UTF-8">
	<title>NM Technology & Integration Solutions</title>
</head>
...
<body>
	<div class="center">
		...
		<h5>Audience:</h5><p></p> The NM Technology website is geared toward providing local small businesses and
	...
	<div class="center"><h2>Persona</h2>
		...
		<h5>Name:</h5><p>Albuquerque Pet Memorial Service</p>

		<h5>Business Name:</h5><p>Pet Cremation Service Provider</p>
		...
		<h5>Technology:</h5><p>APMS employess currently uses paper forms to process companions and this gets messy, presents errors in orders
